...
class RegisterScreen extends StatefulWidget {
  /// Called with the full phone number and the chosen OTP delivery channel
  /// ('sms' or 'email').
  final Function(String phoneNumber, String channel) onSendCode;
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  bool _isValid = false;
  // Chosen OTP delivery channel: 'sms' (default) or 'email'.
  String _channel = 'sms';
  String _selectedCountryCode = '+252';
  // 'SL' is an internal marker for Somaliland: there is no Unicode flag emoji
  // for Somaliland, so this entry renders an SVG asset instead of a glyph.
  ...
  /// Re-evaluate whether the active field (phone for SMS, email for Email)
  /// holds a valid value.
  void _recompute() {
    setState(() {
      _isValid = _channel == 'email'
          ? _emailRe.hasMatch(_emailController.text.trim())
  ...
  /// One selectable OTP-delivery option (SMS or Email). Highlights when chosen.
  Widget _channelCard({
  ...
  /// Renders a country's flag: an SVG asset when one is provided (e.g.
  /// Somaliland, which has no flag emoji), otherwise the emoji glyph.
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(
                      _channel == 'email' ? Icons.email_outlined : Icons.verified_outlined,
                      size: 16,
                  ...
                  children: [
                    Expanded(
                      child: _channelCard(
                        ...
                        label: l10n.channelSms,
                        sublabel: l10n.channelSmsSublabel,
                      ),
                    ),
                    ...
                    Expanded(
                      child: _channelCard(
                        ...
                        sublabel: l10n.channelEmailSublabel,
                      ),
                    ),
                  ],
                ),
