    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(l10n.languagePreviewTitle, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
          const SizedBox(height: 8),
          Text('$previewDate    $previewNumber', style: const TextStyle(fontSize: 16)),
          const SizedBox(height: 20),
